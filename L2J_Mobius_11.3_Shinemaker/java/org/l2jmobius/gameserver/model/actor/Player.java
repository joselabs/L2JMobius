...
public class Player extends Playable
{
	...
	public boolean useMagic(Skill skill, Item item, boolean forceUse, boolean dontMove)
	{
		...
		if (usedSkill.getAlternateRangedSkill() != null)
		{
			final Weapon weapon = getActiveWeaponItem();
			if (weapon != null)
			{
				...
				{
					usedSkill = skill.getAlternateRangedSkill();
				}
				else if (skill.getAlternateMeleeSkill() != null)
				{
					usedSkill = skill.getAlternateMeleeSkill();
				}
			}
		}
			...
			PreparedStatement statement = con.prepareStatement(RESTORE_RELICS))
		{
			...
			try (ResultSet rset = statement.executeQuery())
			{
				while (rset.next())
				{
					...
					if (RelicData.getInstance().getRelic(relicId) != null)
					{
