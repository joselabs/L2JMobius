...
public class ManaHealByLevel extends AbstractEffect
{
	...
	public void onStart(BuffInfo info)
	{
		...
		final SystemMessage sm = new SystemMessage(info.getEffector().getObjectId() != target.getObjectId() ? SystemMessageId.S2_MP_HAS_BEEN_RESTORED_BY_S1 : SystemMessageId.S1_MP_HAS_BEEN_RESTORED);
