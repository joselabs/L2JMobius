...
public class TimedHunting extends AbstractInstance
{
	...
	public TimedHunting()
	{
		...
		addFirstTalkId(RESEARCHERS_TELEPORTER_105, RESEARCHERS_TELEPORTER_110, RESEARCHERS_TELEPORTER_115);
		addFirstTalkId(EXPEDITION_TELEPORTER_105, EXPEDITION_TELEPORTER_110, EXPEDITION_TELEPORTER_115);
		addFirstTalkId(OVERSEER_TELEPORTER_105, OVERSEER_TELEPORTER_110, OVERSEER_TELEPORTER_115);
		addFirstTalkId(INVESTIGATORS_TELEPORTER);
		addFirstTalkId(SEARCH_TEAM_TELEPORTER);
		addFirstTalkId(PATROL_TELEPORTER_105, PATROL_TELEPORTER_115);
		...
		addTalkId(RESEARCHERS_TELEPORTER_105, RESEARCHERS_TELEPORTER_110, RESEARCHERS_TELEPORTER_115);
		addTalkId(EXPEDITION_TELEPORTER_105, EXPEDITION_TELEPORTER_110, EXPEDITION_TELEPORTER_115);
		addTalkId(OVERSEER_TELEPORTER_105, OVERSEER_TELEPORTER_110, OVERSEER_TELEPORTER_115);
		addTalkId(INVESTIGATORS_TELEPORTER);
		addTalkId(SEARCH_TEAM_TELEPORTER);
		addTalkId(PATROL_TELEPORTER_105, PATROL_TELEPORTER_115);
