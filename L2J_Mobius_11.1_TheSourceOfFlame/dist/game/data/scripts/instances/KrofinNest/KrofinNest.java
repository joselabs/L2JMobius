...
public class KrofinNest extends AbstractInstance
{
	...
	public KrofinNest()
	{
		...
		addAttackId(KROSHA_105, KROSHA_110, KROSHA_115);
		addKillId(KROSHA_105, KROSHA_110, KROSHA_115, KROTANION_105, KROPION_105, KROTANION_110, KROPION_110, KROTANION_115, KROPION_115);
	}
		...
		switch (event)
		{
			...
			case "check_status":
			{
				...
				switch (world.getStatus())
				{
					...
					case 2:
					{
						if ((world.getAliveNpcCount(FIRST_AREA_105) == 0) && (world.getAliveNpcCount(FIRST_AREA_110) == 0) && (world.getAliveNpcCount(FIRST_AREA_115) == 0))
						{
							world.setStatus(3);
					...
					case 4:
					{
						if ((world.getAliveNpcCount(SECOND_AREA_105) == 0) && (world.getAliveNpcCount(SECOND_AREA_110) == 0) && (world.getAliveNpcCount(SECOND_AREA_115) == 0))
						{
							world.setStatus(5);
					...
					case 6:
					{
						if ((world.getAliveNpcCount(THIRD_AREA_105) == 0) && (world.getAliveNpcCount(THIRD_AREA_110) == 0) && (world.getAliveNpcCount(THIRD_AREA_115) == 0))
						{
							world.setStatus(7);
							startQuestTimer("door_closed_effects", 5000, null, player);
							startQuestTimer("door_opening_effects", 5000, null, player);
					...
					case 8:
					{
						if ((world.getAliveNpcCount(FOURTH_AREA_105) == 0) && (world.getAliveNpcCount(FOURTH_AREA_110) == 0) && (world.getAliveNpcCount(FOURTH_AREA_115) == 0))
						{
							world.setStatus(9);
							startQuestTimer("door_opening_effects", 5000, null, player);
							startQuestTimer("door_effects_off", 8000, null, player);
